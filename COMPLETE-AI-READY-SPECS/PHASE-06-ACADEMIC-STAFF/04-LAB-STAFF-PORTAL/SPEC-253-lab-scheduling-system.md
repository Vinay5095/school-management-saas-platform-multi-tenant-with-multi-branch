...
Schedule lab sessions with timetable, equipment booking, setup requirements, conflicts prevention, notifications, and usage tracking.
...
```sql
-- Main table for lab scheduling system
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Lab Scheduling System</h1>
...
describe('Lab Scheduling System API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
