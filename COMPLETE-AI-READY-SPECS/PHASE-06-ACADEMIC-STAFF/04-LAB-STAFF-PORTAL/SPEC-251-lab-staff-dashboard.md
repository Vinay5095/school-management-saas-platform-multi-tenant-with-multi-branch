...
Lab management dashboard with equipment status, today's schedule, maintenance alerts, inventory levels, safety compliance, and quick actions.
...
```sql
-- Main table for lab staff dashboard
...
describe('Lab Staff Dashboard API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
