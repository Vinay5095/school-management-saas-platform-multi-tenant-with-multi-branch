...
Mental health resource library, crisis intervention protocols, self-help materials, external referral directory, screening tools, and emergency contacts.
...
```sql
-- Main table for mental health resources
...
describe('Mental Health Resources API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
