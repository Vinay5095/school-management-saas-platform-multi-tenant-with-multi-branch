...
Schedule individual and group counseling sessions with calendar integration, availability management, reminders, cancellations, and session documentation.
...
```sql
-- Main table for counseling session scheduler
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Counseling Session Scheduler</h1>
...
describe('Counseling Session Scheduler API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
