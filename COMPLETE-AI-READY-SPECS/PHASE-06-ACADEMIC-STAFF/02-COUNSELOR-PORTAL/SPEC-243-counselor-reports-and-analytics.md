...
Generate counseling reports including caseload analysis, session statistics, intervention outcomes, behavior trends, and effectiveness metrics.
...
```sql
-- Main table for counselor reports & analytics
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Counselor Reports & Analytics</h1>
...
describe('Counselor Reports & Analytics API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
