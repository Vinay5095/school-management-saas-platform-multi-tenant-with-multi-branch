...
Automated fine calculation for overdue books, damage/loss charges, payment collection, waivers, receipts, and fine reports.
...
```sql
-- Main table for fine calculation & collection
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Fine Calculation & Collection</h1>
...
describe('Fine Calculation & Collection API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
