...
View personal teaching schedule with timetable, room assignments, class details, period information, substitution notifications, and calendar sync.
...
```sql
-- Main table for class schedule viewer
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Class Schedule Viewer</h1>
...
describe('Class Schedule Viewer API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
