...
Complete grade entry system with gradebook view, weighted calculations, grade scales, curve adjustments, bulk entry, grade distribution charts, and export capabilities.
...
```sql
-- Main table for grade entry & gradebook
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Grade Entry & Gradebook</h1>
...
describe('Grade Entry & Gradebook API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
